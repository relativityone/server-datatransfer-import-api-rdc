...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class FolderManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.FolderManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}FolderManager.asmx"
