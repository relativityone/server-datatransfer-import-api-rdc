...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class DocumentManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.DocumentManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}DocumentManager.asmx"
