...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class CodeManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.CodeManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}CodeManager.asmx"
