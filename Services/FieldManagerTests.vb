...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class FieldManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.FieldManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}FieldManager.asmx"
