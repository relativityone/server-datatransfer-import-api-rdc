...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class ExportManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.ExportManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}ExportManager.asmx"
