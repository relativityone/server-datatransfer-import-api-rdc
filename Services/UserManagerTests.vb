...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class UserManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.UserManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}UserManager.asmx"
