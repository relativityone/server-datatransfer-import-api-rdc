...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class SearchManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.SearchManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}SearchManager.asmx"
