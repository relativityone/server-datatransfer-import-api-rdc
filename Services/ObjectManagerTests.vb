...
Namespace kCura.WinEDDS.NUnit.Services
	<TestFixture()> Public Class ObjectManagerTests

#Region " Members "
		Dim _testObj As kCura.WinEDDS.Service.ObjectManager = Nothing
		...
		Const ServiceUrlPageFormat As String = "{0}ObjectManager.asmx"
