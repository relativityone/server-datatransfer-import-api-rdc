...
'		Private _ordinalLookup As System.Collections.Generic.Dictionary(Of String, Int32)
'#End Region
...
'				Me.UpdateHtmlLoadFile(record, hasFullText, documentArtifactID, nativeLocation, fullTextTempFile, doc, extractedTextByteCount)
'				Exit Sub
'			End If
'			Dim count As Int32
...
'		Public Sub UpdateHtmlLoadFile(ByVal record As Object(), ByVal hasFullText As Boolean, ByVal documentArtifactID As Int32, ByVal nativeLocation As String, ByVal fullTextTempFile As String, ByVal doc As Exporters.ObjectExportInfo, ByRef extractedTextByteCount As Int64)
'			Dim count As Int32
'			Dim fieldValue As String
'			Dim columnName As String
'			Dim location As String = nativeLocation
