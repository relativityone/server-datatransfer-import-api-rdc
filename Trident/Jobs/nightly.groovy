...
properties([
	...
	parameters([
		...
		string(defaultValue: 'aio-goatsbeard-3,aio-server2021-juniper-11.1-sp1,aio-osier-2,aio-sundrop-0', description: 'Comma separated list of SUT templates', name: 'temlatesStr')
	]),
