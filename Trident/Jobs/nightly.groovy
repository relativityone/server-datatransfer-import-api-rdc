...
properties([
	...
	parameters([
		...
		string(defaultValue: 'aio-goatsbeard-3,aio-juniper-2-update,aio-osier-2,aio-prairiesmoke-2,aio-sundrop-0', description: 'Comma separated list of SUT templates', name: 'temlatesStr')
	]),
