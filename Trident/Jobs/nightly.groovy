...
properties([
	...
	parameters([
		...
		string(defaultValue: 'aio-server2021-juniper-11.1-sp1,aio-osier-2,aio-sundrop-0,aio-tigerlily-2,aio-whitesedge-eau', description: 'Comma separated list of SUT templates', name: 'temlatesStr')
	]),
