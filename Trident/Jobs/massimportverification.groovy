...
properties([
	...
	parameters([
		...
		choice(defaultValue: 'aio-mayapple-eau', choices: ["lanceleafAA1","aio-mayapple-eau"], description: 'The template used to prepare hopper instance', name: 'hopperTemplate'),
