	...
	Public Class ExceptionHelper
		...
		Public Shared Function IsFatalException (ByVal exception As Exception) As Boolean
			...
			SyncLock SyncRoot
				...
				Dim result As Boolean = FatalExceptionCandidates.Any(function(type) exceptionType = type) OrElse kCura.WinEDDS.TApi.RetryExceptionPolicies.IsOutOfDiskSpaceException(exception)
				Return result
			End SyncLock
		End Function
	End Class	
