    ...
    Public Sub New()
      ...
      'Add any initialization after the InitializeComponent() call
		...
		<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
			...
			'_caseFolderExplorer
			'
			Me._caseFolderExplorer.Dock = System.Windows.Forms.DockStyle.Fill
			Me._caseFolderExplorer.Location = New System.Drawing.Point(0, 0)
		...
		Private Sub _application_OnEvent(ByVal appEvent As AppEvent) Handles _application.OnEvent
			Select Case appEvent.EventType
				...
				Case appEvent.AppEventType.CaseFolderSelected
					...
					UpdateStatus("Case Folder Load: " + _application.SelectedCaseFolderID.ToString)
			End Select
		End Sub
