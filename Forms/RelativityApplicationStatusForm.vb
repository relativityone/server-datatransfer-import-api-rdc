...
#End Region
	...
	Public Sub New(packageData As Byte(), ByVal cred As Net.NetworkCredential, ByVal cookies As Net.CookieContainer, ByVal cases As Generic.IEnumerable(Of Relativity.CaseInfo))
		...
		HelpLink = "http://help.kcura.com/relativity/Relativity%20Applications/7.3/Content/Applications/Import%20with%20the%20Relativity%20Desktop%20Client.htm#kanchor63"
	End Sub
