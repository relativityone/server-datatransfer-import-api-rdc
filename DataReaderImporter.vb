...
Namespace kCura.WinEDDS.ImportExtension
    Public Class DataReaderImporter
        ...
        Public Sub New(ByVal loadFile As kCura.WinEDDS.ImportExtension.DataReaderLoadFile, ByVal controller As kCura.Windows.Process.Controller, ByRef ioReporter As IIoReporter,
            ...
            Me.New(loadFile, controller, ioReporter, bulkLoadFileFieldDelimiter, Nothing, initializeArtifactReader:=True, executionSource:=executionSource)
        End Sub
        ...
        ''' <param name="executionSource">Optional parameter that states where the import
        ''' is coming from.</param>
        Public Sub New(loadFile As kCura.WinEDDS.ImportExtension.DataReaderLoadFile, controller As kCura.Windows.Process.Controller, ByRef ioReporter As IIoReporter, 
            ...
            MyBase.New(loadFile, controller, ioReporter, 0, True, True, System.Guid.NewGuid, True, bulkLoadFileFieldDelimiter, initializeArtifactReader, executionSource)
