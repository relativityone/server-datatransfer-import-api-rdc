...
#End Region
		...
		Public Sub DoHelp()
			...
			Process.Start("http://kcura.com/relativity/Portals/0/Documents/8.1_Documentation_Help_Site/index.htm#Features/Relativity_Desktop_Client/Relativity_Desktop_Client.htm")
