...
#Region "Login"
		...
		Public Async Function DoOAuthLoginAsync(ByVal clientId As String, ByVal clientSecret As String, ByVal stsUrl As Uri) As Task(Of CredentialCheckResult)
			...
			Dim tokenProvider As Relativity.OAuth2Client.Interfaces.ITokenProvider = providerFactory.GetTokenProvider("WebApi", New String() { Relativity.Authentication.Constants.SYSTEM_USER_INFO })
			Try
