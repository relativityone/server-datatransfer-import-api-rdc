	...
	Public Class ImageSettingsFactory
		...
		Public WriteOnly Property CaseArtifactID() As Int32
			Set(ByVal value As Int32)
				...
				_docFields = Me.FieldManager.Query.RetrieveAllAsDocumentFieldCollection(value, kCura.EDDS.Types.ArtifactType.Document)
			End Set
		End Property
			...
			Set(ByVal value As OverwriteType)
				Select Case value
					...
					Case SettingsFactoryBase.OverwriteType.AppendOverlay
						_loadFile.Overwrite = "Append"
					Case SettingsFactoryBase.OverwriteType.Overlay
						_loadFile.Overwrite = "Strict"
				End Select
			End Set
		End Property
