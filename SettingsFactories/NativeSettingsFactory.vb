Namespace kCura.WinEDDS
	Public Class NativeSettingsFactory
		...
		Private Sub InitloadFile(ByVal caseArtifactID As Int32)
			...
			_loadFile.OverwriteDestination = ImportOverwriteModeEnum.Append.ToString
			...
			Set(ByVal value As OverwriteType)
				Select Case value
					...
					Case SettingsFactoryBase.OverwriteType.AppendOverlay
						_loadFile.OverwriteDestination = ImportOverwriteModeEnum.AppendOverlay.ToString
					Case SettingsFactoryBase.OverwriteType.Overlay
						_loadFile.OverwriteDestination = ImportOverwriteModeEnum.Overlay.ToString
				End Select
			End Set
		End Property
