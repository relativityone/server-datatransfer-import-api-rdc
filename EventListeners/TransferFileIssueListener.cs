// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransferFileIssueListener.cs" company="kCura Corp">
...
namespace kCura.WinEDDS.TApi
{
    ...
    /// <summary>
    /// Listens for transfer file issue events.
    /// </summary>
    public class TransferFileIssueListener : TransferListenerBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferFileIssueListener"/> class. 
        /// </summary>
        /// <param name="log">
        /// The transfer log.
        /// </param>
        ...
        /// The client name.
        /// </param>
        public TransferFileIssueListener(ILog log, TransferDirection direction, string clientName) : base(log)
        {
        ...
        /// </param>
        public TransferFileIssueListener(ILog log, TransferDirection direction, string clientName, TransferContext context) : base(log, context)
        {
            this.transferDirection = direction;
            this.clientName = clientName;
        }
        ...
        /// <inheritdoc />
        protected override void OnTransferFileIssueEvent(object sender, TransferFileIssueEventArgs e)
        {
