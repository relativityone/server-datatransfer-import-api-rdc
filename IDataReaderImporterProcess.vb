Namespace kCura.WinEDDS.ImportExtension
	Public Class IDataReaderImporterProcess
		...
		Public Overrides Function GetImporter() As kCura.WinEDDS.BulkLoadFileImporter
			Dim temp As IDataReaderImporter = New IDataReaderImporter(DirectCast(Me.LoadFile, kCura.WinEDDS.ImportExtension.IDataReaderLoadFile))
