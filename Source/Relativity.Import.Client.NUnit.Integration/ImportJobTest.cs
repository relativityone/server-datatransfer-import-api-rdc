...
namespace Relativity.Import.Client.NUnit.Integration
{
	...
	public class ImportJobTest
	{
		...
		public void ShouldImportTheFiles(string clientId)
		{
			...
			if (clientId == TransferClientConstants.AsperaClientId && TestSettings.SkipAsperaModeTests ||
			    clientId == TransferClientConstants.FileShareClientId && TestSettings.SkipDirectModeTests)
			{
				Assert.Ignore(TestSettings.SkipTestMessage, $"{clientId}");
			}
