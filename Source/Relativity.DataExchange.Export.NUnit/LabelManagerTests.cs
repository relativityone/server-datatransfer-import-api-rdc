// -----------------------------------------------------------------------------------------------------
// <copyright file="LabelManagerTests.cs" company="Relativity ODA LLC">
...
namespace Relativity.DataExchange.Export.NUnit
{
	...
	public class LabelManagerTests
	{
		...
		public void SetUp()
		{
			this._volumeMock = new Mock<IVolume>();
			this._subdirectoryMock = new Mock<ISubdirectory>();
		}
		...
		public string ItShouldReturnValidVolumeLabel(int volumeNumber, string prefix, int padding)
		{
			...
			this._volumeMock.SetupGet(x => x.CurrentVolumeNumber).Returns(volumeNumber);
