// -----------------------------------------------------------------------------------------------------
// <copyright file="FullTextLineWriterTests.cs" company="Relativity ODA LLC">
	...
	public class FullTextLineWriterTests
	{
		...
		private static IEnumerable<object[]> DataSetsNoPageOffset()
		{
			yield return new object[]
				             {
					             "text to write",
					             $"FT,{_BATES_NUMBER},1,1,text|0|0|0|0^to|0|0|0|0^write{Environment.NewLine}"
				             };
			yield return new object[]
				             {
					             "text",
					             $"FT,{_BATES_NUMBER},1,1,text{Environment.NewLine}"
				             };
			yield return new object[]
				             {
					             "double  space",
					             $"FT,{_BATES_NUMBER},1,1,double|0|0|0|0^|0|0|0|0^space{Environment.NewLine}"
				             };
			yield return new object[]
				             {
					             "co,mma",
					             $"FT,{_BATES_NUMBER},1,1,comma{Environment.NewLine}"
				             };
			yield return new object[]
				             {
					             $"char{(char)10}10",
					             $"FT,{_BATES_NUMBER},1,1,char|0|0|0|0^10{Environment.NewLine}"
				             };
		}
