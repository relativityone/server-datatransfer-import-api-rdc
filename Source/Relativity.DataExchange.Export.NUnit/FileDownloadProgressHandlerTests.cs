...
namespace Relativity.DataExchange.Export.NUnit
{
	...
	public class FileDownloadProgressHandlerTests : ProgressHandlerTests
	{
		...
		{
			downloadProgressManager.Verify(x => x.MarkFileAsCompleted(id, lineNumber), Times.Once);
		}
		...
		{
			downloadProgressManager.Verify(x => x.MarkFileAsCompleted(id, lineNumber), Times.Never);
		}
	}
}