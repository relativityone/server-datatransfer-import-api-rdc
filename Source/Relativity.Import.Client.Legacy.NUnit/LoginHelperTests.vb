' -----------------------------------------------------------------------------------------------------
' <copyright file="LoginHelperTests.cs" company="Relativity ODA LLC">
	...
	Public Class LoginHelperTests
		...
		Public Sub ShouldNotThrowWhenTheExplicitParameterIsNullOrEmpty(testApplicationName As String, testClientVersion As String, testRelativityVersion As String)
			...
			If String.IsNullOrEmpty(testApplicationName) Then
				ThenTheExceptionMessageShouldEqualTheExpectedValue("Import API", testClientVersion, testRelativityVersion)
			Else If String.IsNullOrEmpty(testClientVersion) Then
				ThenTheExceptionMessageShouldEqualTheExpectedValue(testApplicationName, "0.0.0.0", testRelativityVersion)
			Else If String.IsNullOrEmpty(testRelativityVersion) Then
				ThenTheExceptionMessageShouldEqualTheExpectedValue(testApplicationName, testClientVersion, "0.0.0.0")
			End If
		End Sub
