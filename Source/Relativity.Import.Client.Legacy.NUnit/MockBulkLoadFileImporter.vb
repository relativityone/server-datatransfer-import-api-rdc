...
Namespace Relativity.Import.Client.NUnit
	...
	Public Class MockBulkLoadFileImporter
		...
		Public Sub New(ByVal args As LoadFile, ByVal processController As ProcessContext, ByVal ioReporterInstance As IIoReporter, ByVal logger As ILog, 
		...
		Public Function TryBulkImport(ByVal settings As kCura.EDDS.WebAPI.BulkImportManagerBase.NativeLoadInfo) As MassImportResults
