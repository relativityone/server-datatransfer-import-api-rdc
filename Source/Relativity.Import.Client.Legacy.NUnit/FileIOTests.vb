...
#End Region
	...
	Class Helper
		...
		Public Shared Function Soapify(ex As System.Exception) As SoapException
			...
			Dim soapExDetail As New SoapExceptionDetail(ex)
		...
		Public Shared Sub ModifyRelativitySoapDetails(textToReplace As String, replaceWith As String, exDetail As SoapExceptionDetail)
	...
	Public Interface SoapDetailModifierForMockException
		Sub ModifySoapDetailsToEmulateThisExceptionType(exDetail As SoapExceptionDetail)
	End Interface
