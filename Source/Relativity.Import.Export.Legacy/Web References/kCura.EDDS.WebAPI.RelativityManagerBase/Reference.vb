...
Namespace kCura.EDDS.WebAPI.RelativityManagerBase
    ...
    Partial Public Class RelativityManager
        ...
        Private GetInstanceInformationOperationCompleted As System.Threading.SendOrPostCallback
        
        Private GetRelativityUrlOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event GetInstanceInformationCompleted As GetInstanceInformationCompletedEventHandler
        
        '''<remarks/>
        Public Event GetRelativityUrlCompleted As GetRelativityUrlCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.kCura.com/EDDS/RelativityManager/GetInstanceInformation", RequestNamespace:="http://www.kCura.com/EDDS/RelativityManager", ResponseNamespace:="http://www.kCura.com/EDDS/RelativityManager", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetInstanceInformation() As String
            Dim results() As Object = Me.Invoke("GetInstanceInformation", New Object(-1) {})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Function BeginGetInstanceInformation(ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetInstanceInformation", New Object(-1) {}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndGetInstanceInformation(ByVal asyncResult As System.IAsyncResult) As String
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetInstanceInformationAsync()
            Me.GetInstanceInformationAsync(Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetInstanceInformationAsync(ByVal userState As Object)
            If (Me.GetInstanceInformationOperationCompleted Is Nothing) Then
                Me.GetInstanceInformationOperationCompleted = AddressOf Me.OnGetInstanceInformationOperationCompleted
            End If
            Me.InvokeAsync("GetInstanceInformation", New Object(-1) {}, Me.GetInstanceInformationOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetInstanceInformationOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetInstanceInformationCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetInstanceInformationCompleted(Me, New GetInstanceInformationCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.kCura.com/EDDS/RelativityManager/GetRelativityUrl", RequestNamespace:="http://www.kCura.com/EDDS/RelativityManager", ResponseNamespace:="http://www.kCura.com/EDDS/RelativityManager", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetRelativityUrl() As String
            Dim results() As Object = Me.Invoke("GetRelativityUrl", New Object(-1) {})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Function BeginGetRelativityUrl(ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetRelativityUrl", New Object(-1) {}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndGetRelativityUrl(ByVal asyncResult As System.IAsyncResult) As String
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetRelativityUrlAsync()
            Me.GetRelativityUrlAsync(Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetRelativityUrlAsync(ByVal userState As Object)
            If (Me.GetRelativityUrlOperationCompleted Is Nothing) Then
                Me.GetRelativityUrlOperationCompleted = AddressOf Me.OnGetRelativityUrlOperationCompleted
            End If
            Me.InvokeAsync("GetRelativityUrl", New Object(-1) {}, Me.GetRelativityUrlOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetRelativityUrlOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetRelativityUrlCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetRelativityUrlCompleted(Me, New GetRelativityUrlCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
