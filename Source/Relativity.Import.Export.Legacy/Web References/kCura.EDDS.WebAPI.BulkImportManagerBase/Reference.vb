...
Namespace kCura.EDDS.WebAPI.BulkImportManagerBase
    ...
    Partial Public Class BulkImportManager
        ...
        Private GenerateNonImageErrorFilesOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event GenerateNonImageErrorFilesCompleted As GenerateNonImageErrorFilesCompletedEventHandler
        ...
        Public Function BulkImportImage(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal inRepository As Boolean) As MassImportResults
            Dim results() As Object = Me.Invoke("BulkImportImage", New Object() {appID, settings, inRepository})
            Return CType(results(0),MassImportResults)
        End Function
        
        '''<remarks/>
        Public Function BeginBulkImportImage(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal inRepository As Boolean, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BulkImportImage", New Object() {appID, settings, inRepository}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BulkImportImageAsync(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal inRepository As Boolean)
            Me.BulkImportImageAsync(appID, settings, inRepository, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub BulkImportImageAsync(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal inRepository As Boolean, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("BulkImportImage", New Object() {appID, settings, inRepository}, Me.BulkImportImageOperationCompleted, userState)
        End Sub
        ...
        Public Function BulkImportProductionImage(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal productionArtifactID As Integer, ByVal inRepository As Boolean) As MassImportResults
            Dim results() As Object = Me.Invoke("BulkImportProductionImage", New Object() {appID, settings, productionArtifactID, inRepository})
            Return CType(results(0),MassImportResults)
        End Function
        
        '''<remarks/>
        Public Function BeginBulkImportProductionImage(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal productionArtifactID As Integer, ByVal inRepository As Boolean, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BulkImportProductionImage", New Object() {appID, settings, productionArtifactID, inRepository}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BulkImportProductionImageAsync(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal productionArtifactID As Integer, ByVal inRepository As Boolean)
            Me.BulkImportProductionImageAsync(appID, settings, productionArtifactID, inRepository, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub BulkImportProductionImageAsync(ByVal appID As Integer, ByVal settings As ImageLoadInfo, ByVal productionArtifactID As Integer, ByVal inRepository As Boolean, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("BulkImportProductionImage", New Object() {appID, settings, productionArtifactID, inRepository}, Me.BulkImportProductionImageOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.kCura.com/EDDS/BulkImportManager/GenerateNonImageErrorFiles", RequestNamespace:="http://www.kCura.com/EDDS/BulkImportManager", ResponseNamespace:="http://www.kCura.com/EDDS/BulkImportManager", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GenerateNonImageErrorFiles(ByVal appID As Integer, ByVal runID As String, ByVal artifactTypeID As Integer, ByVal writeHeader As Boolean, ByVal keyFieldID As Integer) As ErrorFileKey
            Dim results() As Object = Me.Invoke("GenerateNonImageErrorFiles", New Object() {appID, runID, artifactTypeID, writeHeader, keyFieldID})
            Return CType(results(0),ErrorFileKey)
        End Function
        
        '''<remarks/>
        Public Function BeginGenerateNonImageErrorFiles(ByVal appID As Integer, ByVal runID As String, ByVal artifactTypeID As Integer, ByVal writeHeader As Boolean, ByVal keyFieldID As Integer, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GenerateNonImageErrorFiles", New Object() {appID, runID, artifactTypeID, writeHeader, keyFieldID}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndGenerateNonImageErrorFiles(ByVal asyncResult As System.IAsyncResult) As ErrorFileKey
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),ErrorFileKey)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GenerateNonImageErrorFilesAsync(ByVal appID As Integer, ByVal runID As String, ByVal artifactTypeID As Integer, ByVal writeHeader As Boolean, ByVal keyFieldID As Integer)
            Me.GenerateNonImageErrorFilesAsync(appID, runID, artifactTypeID, writeHeader, keyFieldID, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GenerateNonImageErrorFilesAsync(ByVal appID As Integer, ByVal runID As String, ByVal artifactTypeID As Integer, ByVal writeHeader As Boolean, ByVal keyFieldID As Integer, ByVal userState As Object)
            If (Me.GenerateNonImageErrorFilesOperationCompleted Is Nothing) Then
                Me.GenerateNonImageErrorFilesOperationCompleted = AddressOf Me.OnGenerateNonImageErrorFilesOperationCompleted
            End If
            Me.InvokeAsync("GenerateNonImageErrorFiles", New Object() {appID, runID, artifactTypeID, writeHeader, keyFieldID}, Me.GenerateNonImageErrorFilesOperationCompleted, userState)
        End Sub
        
        Private Sub OnGenerateNonImageErrorFilesOperationCompleted(ByVal arg As Object)
            If (Not (Me.GenerateNonImageErrorFilesCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GenerateNonImageErrorFilesCompleted(Me, New GenerateNonImageErrorFilesCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    Partial Public Class ImageLoadInfo
        ...
        '''<remarks/>
        Public Property UploadFullText() As Boolean
            Get
                Return Me.uploadFullTextField
            End Get
            Set
                Me.uploadFullTextField = value
            End Set
        End Property
        
        '''<remarks/>
        Public Property BulkFileName() As String
            Get
                Return Me.bulkFileNameField
            End Get
            Set
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.6.1055.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute([Namespace]:="http://www.kCura.com/EDDS/BulkImportManager")>  _
    Partial Public Class LoadRange
    ...
    Partial Public Class NativeLoadInfo
        ...
        Private rangeField As LoadRange
        ...
        Private moveDocumentsInAppendOverlayModeField As Boolean
        ...
        Public Property OnBehalfOfUserToken() As String
            Get
                Return Me.onBehalfOfUserTokenField
            End Get
            Set
                Me.onBehalfOfUserTokenField = value
            End Set
        End Property
        ...
        Public Property BulkLoadFileFieldDelimiter() As String
            Get
                Return Me.bulkLoadFileFieldDelimiterField
            End Get
            Set
        ...
        '''<remarks/>
        Public Property LinkDataGridRecords() As Boolean
            Get
                Return Me.linkDataGridRecordsField
            End Get
            Set
                Me.linkDataGridRecordsField = value
            End Set
        End Property
        ...
        '''<remarks/>
        Public Property MoveDocumentsInAppendOverlayMode() As Boolean
            Get
                Return Me.moveDocumentsInAppendOverlayModeField
            End Get
            Set
                Me.moveDocumentsInAppendOverlayModeField = value
            End Set
        End Property
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")>  _
    Public Delegate Sub GenerateNonImageErrorFilesCompletedEventHandler(ByVal sender As Object, ByVal e As GenerateNonImageErrorFilesCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class GenerateNonImageErrorFilesCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
