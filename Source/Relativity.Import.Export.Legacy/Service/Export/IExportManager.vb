Namespace kCura.WinEDDS.Service.Export
	Public Interface IExportManager
		...
		Function RetrieveResultsBlockStartingFromIndex(appID As Int32, runId As Guid, artifactTypeID As Int32, avfIds As Int32(), chunkSize As Int32, displayMulticodesAsNested As Boolean, multiValueDelimiter As Char, nestedValueDelimiter As Char, textPrecedenceAvfIds As Int32(), index As Int32) As Object()
