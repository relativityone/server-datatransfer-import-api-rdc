...
Namespace Relativity.DataExchange.Import.NUnit
	...
	Public Class OriginalFileNameProviderTests
		...
		<Test>
		Public Sub ItShouldNotAddFileNameFieldWhenRequestedFieldsListIsNothing()
			'Arrange
		...
		<Test>
		Public Sub ItShouldAddFileNameFieldWhenRequestedFieldsListIsEmpty()
			'Arrange
		...
		<Test>
		Public Sub ItShouldAddFileNameFieldWhenRequestedFieldsListDoesNotContainFileName()
			'Arrange
		...
		<Test>
		Public Sub ItShouldNotAddFileNameFieldWhenRequestedFieldsListContainsFileName()
			'Arrange
		...
		<Test>
		Public Sub ItShouldNotAddFileNameFieldWhenFileNameFieldIsNotPresent()
			'Arrange
			Dim requestedFields As List(Of Integer) = CreateFieldsListWithoutFileNameFieldPresent()
		...
		<Test>
		Public Sub ItShouldNotAddFileNameFieldWhenExportableFieldsArrayIsNothing()
			'Arrange
			Dim requestedFields As List(Of Integer) = CreateFieldsListWithFileNameFieldPresent()
		...
		<Test>
		Public Sub ItShouldNotAddFileNameFieldWhenItsTypeIsLongText()
			'Arrange
			Dim requestedFields As List(Of Integer) = CreateFieldsListWithoutFileNameFieldPresent()
		...
		<Test>
		Public Sub ItShouldReturnMetadataFileNameWhenFileNameFieldIsPresentAndValueIsCorrect()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
		...
		<Test>
		Public Sub ItShouldNotWriteWarningWhenMetadataFileNameIsPresentAndValueIsCorrect()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
			Dim fileNameFromDocumentTable As String = "originalFile.html"
			Dim fileNameProvider As OriginalFileNameProvider = New OriginalFileNameProvider(True, _fieldLookupService.Object, AddressOf WriteWarning)
		...
		<Test>
		Public Sub ItShouldReturnFileTableFileNameWhenMetadataFileNameIsPresentButFileNameFlagIsFalse()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
			Dim fileNameFromDocumentTable As String = "originalFile.html"
			Dim fileNameProvider As OriginalFileNameProvider = New OriginalFileNameProvider(False, _fieldLookupService.Object, AddressOf WriteWarning)
		...
		<Test>
		Public Sub ItShouldNotWriteWarningWhenMetadataFileNamedIsPresentButFileNameFlagIsFalse()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
			Dim fileNameFromDocumentTable As String = "originalFile.html"
			Dim fileNameProvider As OriginalFileNameProvider = New OriginalFileNameProvider(False, _fieldLookupService.Object, AddressOf WriteWarning)
		...
		<Test>
		Public Sub ItShouldReturnFileTableFileNameWhenMetadataFileNameIsPresentButEmpty()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
		...
		<Test>
		Public Sub ItShouldReturnFileTableFileNameWhenMetadataFileNameIsPresentButNull()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
		...
		<Test>
		Public Sub ItShouldReturnDocumentFileNameEvenWhenInvalidCharactersArePresent
		...
		<Test>
		Public Sub ItShouldWriteWarningWhenMetadataFileNameIsEmpty()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
			Dim fileNameFromDocumentTable As String = ""
			Dim fileNameProvider As OriginalFileNameProvider = New OriginalFileNameProvider(True, _fieldLookupService.Object, AddressOf WriteWarning)
		...
		<Test>
		Public Sub ItShouldWriteWarningForInvalidMetadataFileName()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
			Dim fileNameFromDocumentTable As String = "originalFile.html"
			Dim fileNameProvider As OriginalFileNameProvider = New OriginalFileNameProvider(True, _fieldLookupService.Object, AddressOf WriteWarning)
		...
		<Test>
		Public Sub ItShouldReturnCorrectFileNameForSequenceOfValidAndInvalidMetadataFileNameValues()
			'Arrange
			Dim fileNameFromFileTable As String = "CN0001.txt"
			Dim fileNameFromDocumentTable As String = "originalFile.html"
			Dim fileNameProvider As OriginalFileNameProvider = New OriginalFileNameProvider(True, _fieldLookupService.Object, AddressOf WriteWarning)
