namespace Relativity.DataExchange.Export.VolumeManagerV2.Metadata.Natives
{
	...
	public class LoadFileLine : ILoadFileLine
	{
		...
		public LoadFileLine(LinePrefix prefix, ILineFieldsValue fieldsValue, LineImageField imageField, ILineNativeFilePath nativeFilePath, ILinePdfFilePath pdfFilePath, LineSuffix suffix, LineNewLine newLine,
			ILog logger)
		{
			_prefix = prefix;
		...
		public ILoadFileEntry CreateLine(ObjectExportInfo artifact)
		{
			...
			_pdfFilePath.AddPdfFilePath(loadFileEntry, artifact);
