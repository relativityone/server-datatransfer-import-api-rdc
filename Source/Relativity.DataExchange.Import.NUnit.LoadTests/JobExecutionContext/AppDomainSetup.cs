...
namespace Relativity.DataExchange.Import.NUnit.LoadTests.JobExecutionContext
{
	...
	public class AppDomainSetup : MarshalByRefObject
	{
		...
		/// <param name="workspaceId">actual workspace id.</param>
		...
		public void SetupAppDomain(IntegrationTestParameters parameters, int workspaceId)
		{
			...
			AssemblySetup.TestParameters.WorkspaceId = workspaceId;
