			...
			private async Task PrepareFieldsAsync(int index)
			{
				...
				await Task.WhenAll(
					FieldHelper.CreateSingleObjectFieldAsync(
						...
						associativeObjectArtifactTypeId: smallSingleObjectTypeArtifactId,
						workspaceId: this.WorkspaceIds[index]),
					FieldHelper.CreateSingleObjectFieldAsync(
						this.testParameters,
						MediumSingleObjectFieldName,
						objectArtifactTypeId: (int)ArtifactType.Document,
						associativeObjectArtifactTypeId: mediumSingleObjectTypeArtifactId,
						workspaceId: this.WorkspaceIds[index]),
					FieldHelper.CreateMultiObjectFieldAsync(
						this.testParameters,
						SmallMultiObjectFieldName,
						objectArtifactTypeId: (int)ArtifactType.Document,
						associativeObjectArtifactTypeId: smallMultiObjectTypeArtifactId,
						workspaceId: this.WorkspaceIds[index]),
					FieldHelper.CreateMultiObjectFieldAsync(
						this.testParameters,
						MediumMultiObjectFieldName,
						objectArtifactTypeId: (int)ArtifactType.Document,
						associativeObjectArtifactTypeId: mediumMultiObjectTypeArtifactId,
						workspaceId: this.WorkspaceIds[index]),
