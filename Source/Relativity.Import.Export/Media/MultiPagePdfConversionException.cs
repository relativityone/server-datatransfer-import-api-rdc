// ----------------------------------------------------------------------------
// <copyright file="ConvertToMultiPagePdfException.cs" company="Relativity ODA LLC">
...
namespace Relativity.Import.Export.Media
{
	...
	public sealed class ConvertToMultiPagePdfException : ImageRollupException
	{
		...
		/// </summary>
		public ConvertToMultiPagePdfException()
		{
		}
		...
		/// </param>
		public ConvertToMultiPagePdfException(string message)
			: base(message)
		{
		}
		...
		/// </param>
		public ConvertToMultiPagePdfException(string message, Exception innerException)
		...
		/// The exception that is the cause of the current exception, or a null reference (Nothing in Visual Basic) if no inner exception is specified.
		/// </param>
		public ConvertToMultiPagePdfException(string file, int pageNumber, int pageCount, Exception innerException)
