// ----------------------------------------------------------------------------
// <copyright file="MultiPageTiffConversionException.cs" company="Relativity ODA LLC">
...
namespace Relativity.Import.Export.Media
{
	...
	/// </summary>
	[Serializable]
	public sealed class MultiPageTiffConversionException : ImageConversionException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="MultiPageTiffConversionException"/> class.
		/// </summary>
		public MultiPageTiffConversionException()
		{
		}
		...
		/// </param>
		private MultiPageTiffConversionException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
