...
Namespace kCura.WinEDDS.Service
	Public Class ExportManager
		...
		Implements Export.IExportManager, Replacement.IExportManager
		...
		Public Sub New(ByVal credentials As Net.ICredentials, ByVal cookieContainer As System.Net.CookieContainer)
			...
			Me.Url = String.Format("{0}ExportManager.asmx", AppSettings.Instance.WebApiServiceUrl)
		...
		Public Shadows Function RetrieveResultsBlockForProductionStartingFromIndex(appID As Integer, runId As Guid, artifactTypeID As Integer, avfIds As Integer(), chunkSize As Integer, displayMulticodesAsNested As Boolean, multiValueDelimiter As Char, nestedValueDelimiter As Char, textPrecedenceAvfIds As Integer(), productionId As Integer, index As Integer) As Object() Implements Export.IExportManager.RetrieveResultsBlockForProductionStartingFromIndex, Replacement.IExportManager.RetrieveResultsBlockForProductionStartingFromIndex
		...
		Public Shadows Function InitializeProductionExport(ByVal appID As Int32, ByVal productionArtifactID As Int32, ByVal avfIds As Int32(), ByVal startAtRecord As Int32) As kCura.EDDS.WebAPI.ExportManagerBase.InitializationResults Implements Export.IExportManager.InitializeProductionExport, Replacement.IExportManager.InitializeProductionExport
			Return MakeCallAttemptReLogin(Function() MyBase.InitializeProductionExport(appID, productionArtifactID, avfIds, startAtRecord))
		End Function

		Public Shadows Function InitializeSearchExport(ByVal appID As Int32, ByVal searchArtifactID As Int32, ByVal avfIds As Int32(), ByVal startAtRecord As Int32) As kCura.EDDS.WebAPI.ExportManagerBase.InitializationResults Implements Export.IExportManager.InitializeSearchExport, Replacement.IExportManager.InitializeSearchExport
			Return MakeCallAttemptReLogin(Function() MyBase.InitializeSearchExport(appID, searchArtifactID, avfIds, startAtRecord))
		End Function

		Public Shadows Function RetrieveResultsBlockStartingFromIndex(appID As Integer, runId As Guid, artifactTypeID As Integer, avfIds As Integer(), chunkSize As Integer, displayMulticodesAsNested As Boolean, multiValueDelimiter As Char, nestedValueDelimiter As Char, textPrecedenceAvfIds As Integer(), index As Integer) As Object() Implements Export.IExportManager.RetrieveResultsBlockStartingFromIndex, Replacement.IExportManager.RetrieveResultsBlockStartingFromIndex
		...
		Public Shadows Function HasExportPermissions(appID As Int32) As Boolean Implements Export.IExportManager.HasExportPermissions, Replacement.IExportManager.HasExportPermissions
