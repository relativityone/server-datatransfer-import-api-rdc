...
#Region "Worker Methods"
		...
		Private Sub GetImagesForDocument(ByVal lines As System.Collections.Generic.List(Of Api.ImageRecord), ByVal status As Int64)
			...
			For i As Int32 = 0 To lines.Count - 1
				...
				Me.GetImageForDocument(imageFilePath, originalFileName, record.BatesNumber, documentId, i, offset, textFileList, i < lines.Count - 1, Convert.ToInt32(record.OriginalIndex), status, lines.Count, i = 0)
			Next
