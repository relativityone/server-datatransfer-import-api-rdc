...
#Region "Main"
		...
		Protected Sub LowerBatchSizeAndRetry(ByVal oldBulkLoadFilePath As String, ByVal dataGridFilePath As String, ByVal totalRecords As Int32)
			...
			Dim newBulkLoadFilePath As String = TempFileBuilder.CreateZeroByte(TempFileConstants.NativeLoadFileNameSuffix)
		...
		Public Sub ReadFile(ByVal path As String)
			...
			Dim bulkLoadFilePath As String = TempFileBuilder.CreateZeroByte(TempFileConstants.NativeLoadFileNameSuffix)
			Dim dataGridFilePath As String = TempFileBuilder.CreateZeroByte(TempFileConstants.DatagridLoadFileNameSuffix)
...
#Region "Events and Event Handling"
		...
		Private Sub RaiseReportError(ByVal row As System.Collections.Hashtable, ByVal lineNumber As Int32, ByVal identifier As String, ByVal type As String)
			...
			If _errorMessageFileLocation = "" Then
				_errorMessageFileLocation = TempFileBuilder.CreateZeroByte(TempFileConstants.ErrorsFileNameSuffix)
			End If
...
#End Region
		...
		Private Sub ManageErrors()
			...
			If _errorRowsFileLocation = "" Then
				_errorRowsFileLocation = TempFileBuilder.CreateZeroByte(TempFileConstants.ErrorsFileNameSuffix)
			End If
			...
			Try
				With _bulkImportManager.GenerateImageErrorFiles(_caseInfo.ArtifactID, _runId, True, _keyFieldDto.ArtifactID)
					...
					Dim errorsLocation As String = TempFileBuilder.CreateZeroByte(TempFileConstants.ErrorsFileNameSuffix)
					...
					Else
						...
						End While
						sr.Close()
						Dim tmp As String = TempFileBuilder.CreateZeroByte(TempFileConstants.ErrorsFileNameSuffix)
