...
Namespace kCura.EDDS.WebAPI.SearchManagerBase
    ...
    Partial Public Class SearchManager
        ...
        Private RetrievePdfForSearchOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event RetrievePdfForSearchCompleted As RetrievePdfForSearchCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.kCura.com/EDDS/SearchManager/RetrievePdfForSearch", RequestNamespace:="http://www.kCura.com/EDDS/SearchManager", ResponseNamespace:="http://www.kCura.com/EDDS/SearchManager", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function RetrievePdfForSearch(ByVal caseContextArtifactID As Integer, ByVal documentArtifactIDs As String) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("RetrievePdfForSearch", New Object() {caseContextArtifactID, documentArtifactIDs})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '''<remarks/>
        Public Function BeginRetrievePdfForSearch(ByVal caseContextArtifactID As Integer, ByVal documentArtifactIDs As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("RetrievePdfForSearch", New Object() {caseContextArtifactID, documentArtifactIDs}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndRetrievePdfForSearch(ByVal asyncResult As System.IAsyncResult) As System.Data.DataSet
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '''<remarks/>
        Public Overloads Sub RetrievePdfForSearchAsync(ByVal caseContextArtifactID As Integer, ByVal documentArtifactIDs As String)
            Me.RetrievePdfForSearchAsync(caseContextArtifactID, documentArtifactIDs, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub RetrievePdfForSearchAsync(ByVal caseContextArtifactID As Integer, ByVal documentArtifactIDs As String, ByVal userState As Object)
            If (Me.RetrievePdfForSearchOperationCompleted Is Nothing) Then
                Me.RetrievePdfForSearchOperationCompleted = AddressOf Me.OnRetrievePdfForSearchOperationCompleted
            End If
            Me.InvokeAsync("RetrievePdfForSearch", New Object() {caseContextArtifactID, documentArtifactIDs}, Me.RetrievePdfForSearchOperationCompleted, userState)
        End Sub
        
        Private Sub OnRetrievePdfForSearchOperationCompleted(ByVal arg As Object)
            If (Not (Me.RetrievePdfForSearchCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent RetrievePdfForSearchCompleted(Me, New RetrievePdfForSearchCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0")>  _
    Public Delegate Sub RetrievePdfForSearchCompletedEventHandler(ByVal sender As Object, ByVal e As RetrievePdfForSearchCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class RetrievePdfForSearchCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
