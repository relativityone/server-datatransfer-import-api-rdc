...
namespace Relativity.DataExchange.NUnit.Integration
{
	...
	public abstract class TapiBridgeTestBase
	{
		...
		public void Teardown()
		{
			...
			this.CleanupTheAutoGeneratedDataset();
		}
		...
		/// <summary>
		/// Cleans the generated data from the target.
		/// </summary>
		protected void CleanupTheAutoGeneratedDataset()
		{
			foreach (var path in this.SourcePaths)
			{
				...
				{
					this.TransferLog.LogInformation("Could not delete the generated files for the tapi bridge tests");
				}
			}
		}
