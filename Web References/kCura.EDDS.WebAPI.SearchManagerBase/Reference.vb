...
Namespace kCura.EDDS.WebAPI.SearchManagerBase
    ...
    Public Class SearchManager
        ...
        Public Function RetrieveFullTextFilesForSearch(ByVal caseContextArtifactID As Integer, ByVal documentArtifactIDs As String) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("RetrieveFullTextFilesForSearch", New Object() {caseContextArtifactID, documentArtifactIDs})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '<remarks/>
        Public Function BeginRetrieveFullTextFilesForSearch(ByVal caseContextArtifactID As Integer, ByVal documentArtifactIDs As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("RetrieveFullTextFilesForSearch", New Object() {caseContextArtifactID, documentArtifactIDs}, callback, asyncState)
        End Function
