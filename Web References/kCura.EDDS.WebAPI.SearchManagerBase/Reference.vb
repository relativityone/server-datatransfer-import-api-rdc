...
Namespace kCura.EDDS.WebAPI.SearchManagerBase
    ...
    Public Class SearchManager
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://localhost/EDDS/WebAPI/SearchManager.asmx"
        End Sub
        ...
        Public Function RetrieveNativesForSearch(ByVal artifactID As Integer, ByVal documentIDs As String) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("RetrieveNativesForSearch", New Object() {artifactID, documentIDs})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '<remarks/>
        Public Function BeginRetrieveNativesForSearch(ByVal artifactID As Integer, ByVal documentIDs As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("RetrieveNativesForSearch", New Object() {artifactID, documentIDs}, callback, asyncState)
        End Function
        ...
        Public Function RetrieveFullTextFilesForSearch(ByVal artifactID As Integer, ByVal documentIDs As String) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("RetrieveFullTextFilesForSearch", New Object() {artifactID, documentIDs})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '<remarks/>
        Public Function BeginRetrieveFullTextFilesForSearch(ByVal artifactID As Integer, ByVal documentIDs As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("RetrieveFullTextFilesForSearch", New Object() {artifactID, documentIDs}, callback, asyncState)
        End Function
