...
Namespace kCura.EDDS.WebAPI.ProductionManagerBase
    ...
    Partial Public Class ProductionManager
        ...
        Private RetrieveBatesByProductionAndDocumentOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event RetrieveBatesByProductionAndDocumentCompleted As RetrieveBatesByProductionAndDocumentCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.kCura.com/EDDS/ProductionManager/RetrieveBatesByProductionAndDocument", RequestNamespace:="http://www.kCura.com/EDDS/ProductionManager", ResponseNamespace:="http://www.kCura.com/EDDS/ProductionManager", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function RetrieveBatesByProductionAndDocument(ByVal caseContextArtifactID As Integer, ByVal productionIds() As Integer, ByVal documentIds() As Integer) As <System.Xml.Serialization.XmlArrayItemAttribute("ArrayOfAnyType"), System.Xml.Serialization.XmlArrayItemAttribute(NestingLevel:=1)> Object()()
            Dim results() As Object = Me.Invoke("RetrieveBatesByProductionAndDocument", New Object() {caseContextArtifactID, productionIds, documentIds})
            Return CType(results(0),Object()())
        End Function
        
        '''<remarks/>
        Public Function BeginRetrieveBatesByProductionAndDocument(ByVal caseContextArtifactID As Integer, ByVal productionIds() As Integer, ByVal documentIds() As Integer, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("RetrieveBatesByProductionAndDocument", New Object() {caseContextArtifactID, productionIds, documentIds}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndRetrieveBatesByProductionAndDocument(ByVal asyncResult As System.IAsyncResult) As Object()()
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Object()())
        End Function
        
        '''<remarks/>
        Public Overloads Sub RetrieveBatesByProductionAndDocumentAsync(ByVal caseContextArtifactID As Integer, ByVal productionIds() As Integer, ByVal documentIds() As Integer)
            Me.RetrieveBatesByProductionAndDocumentAsync(caseContextArtifactID, productionIds, documentIds, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub RetrieveBatesByProductionAndDocumentAsync(ByVal caseContextArtifactID As Integer, ByVal productionIds() As Integer, ByVal documentIds() As Integer, ByVal userState As Object)
            If (Me.RetrieveBatesByProductionAndDocumentOperationCompleted Is Nothing) Then
                Me.RetrieveBatesByProductionAndDocumentOperationCompleted = AddressOf Me.OnRetrieveBatesByProductionAndDocumentOperationCompleted
            End If
            Me.InvokeAsync("RetrieveBatesByProductionAndDocument", New Object() {caseContextArtifactID, productionIds, documentIds}, Me.RetrieveBatesByProductionAndDocumentOperationCompleted, userState)
        End Sub
        
        Private Sub OnRetrieveBatesByProductionAndDocumentOperationCompleted(ByVal arg As Object)
            If (Not (Me.RetrieveBatesByProductionAndDocumentCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent RetrieveBatesByProductionAndDocumentCompleted(Me, New RetrieveBatesByProductionAndDocumentCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.81.0")>  _
    Public Delegate Sub RetrieveBatesByProductionAndDocumentCompletedEventHandler(ByVal sender As Object, ByVal e As RetrieveBatesByProductionAndDocumentCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.81.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class RetrieveBatesByProductionAndDocumentCompletedEventArgs
