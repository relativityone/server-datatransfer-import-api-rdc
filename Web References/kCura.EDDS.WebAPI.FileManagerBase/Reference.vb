...
Namespace kCura.EDDS.WebAPI.FileManagerBase
    ...
    Partial Public Class FileManager
        ...
        Private GetBatesByImageGuidOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event GetBatesByImageGuidCompleted As GetBatesByImageGuidCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.kCura.com/EDDS/FileManager/GetBatesByImageGuid", RequestNamespace:="http://www.kCura.com/EDDS/FileManager", ResponseNamespace:="http://www.kCura.com/EDDS/FileManager", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetBatesByImageGuid(ByVal caseContextArtifactID As Integer, ByVal guid As String) As String
            Dim results() As Object = Me.Invoke("GetBatesByImageGuid", New Object() {caseContextArtifactID, guid})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Function BeginGetBatesByImageGuid(ByVal caseContextArtifactID As Integer, ByVal guid As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetBatesByImageGuid", New Object() {caseContextArtifactID, guid}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndGetBatesByImageGuid(ByVal asyncResult As System.IAsyncResult) As String
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetBatesByImageGuidAsync(ByVal caseContextArtifactID As Integer, ByVal guid As String)
            Me.GetBatesByImageGuidAsync(caseContextArtifactID, guid, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetBatesByImageGuidAsync(ByVal caseContextArtifactID As Integer, ByVal guid As String, ByVal userState As Object)
            If (Me.GetBatesByImageGuidOperationCompleted Is Nothing) Then
                Me.GetBatesByImageGuidOperationCompleted = AddressOf Me.OnGetBatesByImageGuidOperationCompleted
            End If
            Me.InvokeAsync("GetBatesByImageGuid", New Object() {caseContextArtifactID, guid}, Me.GetBatesByImageGuidOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetBatesByImageGuidOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetBatesByImageGuidCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetBatesByImageGuidCompleted(Me, New GetBatesByImageGuidCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")>  _
    Public Delegate Sub GetBatesByImageGuidCompletedEventHandler(ByVal sender As Object, ByVal e As GetBatesByImageGuidCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class GetBatesByImageGuidCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
