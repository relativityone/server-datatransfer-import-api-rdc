...
Namespace kCura.EDDS.WebAPI.BulkImportManagerBase
    ...
    Partial Public Class BulkImportManager
        ...
        '''<remarks/>
        Public Overloads Sub BulkImportImageAsync(ByVal appID As Integer, ByVal bulkFileName As String, ByVal uploadFullText As Boolean, ByVal overwrite As OverwriteType, ByVal destinationFolderArtifactID As Integer, ByVal repository As String, ByVal useBulk As Boolean, ByVal runID As String, ByVal keyFieldID As Integer)
            Me.BulkImportImageAsync(appID, bulkFileName, uploadFullText, overwrite, destinationFolderArtifactID, repository, useBulk, runID, keyFieldID, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub BulkImportImageAsync(ByVal appID As Integer, ByVal bulkFileName As String, ByVal uploadFullText As Boolean, ByVal overwrite As OverwriteType, ByVal destinationFolderArtifactID As Integer, ByVal repository As String, ByVal useBulk As Boolean, ByVal runID As String, ByVal keyFieldID As Integer, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("BulkImportImage", New Object() {appID, bulkFileName, uploadFullText, overwrite, destinationFolderArtifactID, repository, useBulk, runID, keyFieldID}, Me.BulkImportImageOperationCompleted, userState)
        End Sub
        ...
        Public Overloads Sub BulkImportProductionImageAsync(ByVal appID As Integer, ByVal bulkFileName As String, ByVal uploadFullText As Boolean, ByVal overwrite As OverwriteType, ByVal destinationFolderArtifactID As Integer, ByVal repository As String, ByVal productionArtifactID As Integer, ByVal useBulk As Boolean, ByVal runID As String, ByVal productionKeyFieldArtifactID As Integer)
            Me.BulkImportProductionImageAsync(appID, bulkFileName, uploadFullText, overwrite, destinationFolderArtifactID, repository, productionArtifactID, useBulk, runID, productionKeyFieldArtifactID, Nothing)
        End Sub
        ...
        Public Overloads Sub BulkImportProductionImageAsync(ByVal appID As Integer, ByVal bulkFileName As String, ByVal uploadFullText As Boolean, ByVal overwrite As OverwriteType, ByVal destinationFolderArtifactID As Integer, ByVal repository As String, ByVal productionArtifactID As Integer, ByVal useBulk As Boolean, ByVal runID As String, ByVal productionKeyFieldArtifactID As Integer, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("BulkImportProductionImage", New Object() {appID, bulkFileName, uploadFullText, overwrite, destinationFolderArtifactID, repository, productionArtifactID, useBulk, runID, productionKeyFieldArtifactID}, Me.BulkImportProductionImageOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        Public Overloads Sub BulkImportNativeAsync(ByVal appID As Integer, ByVal settings As NativeLoadInfo)
            Me.BulkImportNativeAsync(appID, settings, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub BulkImportNativeAsync(ByVal appID As Integer, ByVal settings As NativeLoadInfo, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("BulkImportNative", New Object() {appID, settings}, Me.BulkImportNativeOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        Public Overloads Sub BulkImportObjectsAsync(ByVal appID As Integer, ByVal settings As ObjectLoadInfo)
            Me.BulkImportObjectsAsync(appID, settings, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub BulkImportObjectsAsync(ByVal appID As Integer, ByVal settings As ObjectLoadInfo, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("BulkImportObjects", New Object() {appID, settings}, Me.BulkImportObjectsOperationCompleted, userState)
        End Sub
