...
#End Region
		...
		Protected Sub InitializeArtifactReader()
			...
			If _keyFieldID > 0 AndAlso args.OverwriteDestination.ToLower <> ImportOverwriteModeEnum.Overlay.ToString.ToLower AndAlso args.ArtifactTypeID = Relativity.ArtifactType.Document Then
				_keyFieldID = -1
			End If
